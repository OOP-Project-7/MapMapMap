...
public class MapsActivityLibrary extends FragmentActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mapslibrary);
        // Obtain the SupportMapFragment and get notified when the map is ready to be used.
        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.maplibrary);
    ...
    public void onMapReady(GoogleMap googleMap) { //매개변수로 GoogleMap 객체가 넘어옴
        googleMap.moveCamera(CameraUpdateFactory.newLatLng(
                new LatLng(36.012839, 129.325154) //위도 경도
        ));
        ...
        marker.position(new LatLng(36.012839, 129.325154))
                .title("도서관")
                .snippet("LIB");
